...
let animal = new Animal("drosofila", "mosca", 0.5, ["cidade", "campo"]);
console.log(animal);
...
console.log(animal.getEspecie);
console.log("");
let outroAnimal = new Animal("Borboleta-do-manacá", "borboleta", 0.2, ["cidade", "campo", "casa"]);
...
console.log(outroAnimal.getEspecie);
console.log("");
let aluno = new Aluno("Arthur Estevan Vargas", 19, [10, 9, 8]);
console.log(aluno.apresentar());
console.log(aluno.calcularMedia());
console.log("");
let professor = new Professor("Rubem Oliota", 33, ["Java", "JavaScrip", "TypeScrip"], 80, 12);
...
console.log("");
let vendedor = new Vendedor("Arthur Estevan Vargas", 19, 10, 50);
